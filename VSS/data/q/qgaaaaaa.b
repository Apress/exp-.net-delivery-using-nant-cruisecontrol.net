<project>
    <assemblies>
        <assembly location="D:\BookCode\Projects\Transformer\TransformerGui\bin\Debug\TransformerGui.exe" documentation="D:\BookCode\Projects\Transformer\TransformerGui\bin\Debug\TransformerGui.xml" />
        <assembly location="D:\BookCode\Projects\Transformer\TransformerGui\bin\Debug\TransformerEngine.dll" documentation="D:\BookCode\Projects\Transformer\TransformerGui\bin\Debug\TransformerEngine.xml" />
    </assemblies>
    <namespaces>
        <namespace name="TransformerEngine"></namespace>
        <namespace name="TransformerGui"></namespace>
    </namespaces>
    <documenters>
        <documenter name="HtmlHelp2">
            <property name="CharacterSet" value="Ascii" />
            <property name="LangID" value="1033" />
            <property name="DeleteCHM" value="False" />
            <property name="AugmentXmlDataIslands" value="True" />
            <property name="RegisterTitleWithNamespace" value="False" />
            <property name="ParentCollectionNamespace" value="" />
        ...
        <documenter name="MSDN">
            ...
            <property name="HtmlHelpName" value="Documentation" />
            <property name="IncludeFavorites" value="False" />
            <property name="Title" value="Transformer" />
            <property name="SplitTOCs" value="False" />
            <property name="DefaulTOC" value="" />
            <property name="IncludeHierarchy" value="False" />
            <property name="ShowVisualBasic" value="False" />
